...
const FeedbackScreen = ({ navigation }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert(
        ...
        safeTranslate('feedback.submissionSuccess', 'Your feedback has been submitted successfully.'),
        [
          {
  ...
  const renderContactItems = () => {
    const contacts = [
      { name: 'National Helpline', number: '1-800-662-HELP' },
  ...
  const renderCategoryButtons = () => {
    const categories = [
      { id: 'general', label: safeTranslate('feedback.categoryGeneral', 'General Feedback') },
      { id: 'suggestion', label: safeTranslate('feedback.categorySuggestion', 'Suggestion') },
      { id: 'issue', label: safeTranslate('feedback.categoryIssue', 'Report Issue') },
      { id: 'help', label: safeTranslate('feedback.categoryHelp', 'Need Help') }
    ];
      ...
      >
        ...
        <Card style={styles.emergencyCard}>
          ...
          <Text style={styles.emergencySubtitle}>
            {safeTranslate('feedback.emergencySubtitle', 'If you need immediate help, contact these resources:')}
          </Text>
        ...
        <Card style={styles.formCard}>
          ...
          <TextInput
            ...
            placeholder={safeTranslate('feedback.namePlaceholder', 'Enter your name')}
          ...
          <TextInput
            ...
            placeholder={safeTranslate('feedback.emailPlaceholder', 'Enter your email')}
          ...
          <TextInput
            ...
            placeholder={safeTranslate('feedback.messagePlaceholder', 'Enter your message, feedback, or request for help...')}
            multiline
            numberOfLines={6}
